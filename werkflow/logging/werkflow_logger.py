...
from werkflow.logging.spinner import ProgressText
...
class WerkflowLogger:
    ...
    def initialize(self, config: LoggingConfig=LoggingConfig()):
        ...
        for logger_type in self.logger_types:
            ...
            elif logger_type == LoggerTypes.DISTRIBUTED or logger_type == LoggerTypes.WERKFLOW:
    ...
    @property
    def werkflow(self) -> Logger[AsyncLogger, SyncLogger]:
        return self.loggers['werkflow'] 
